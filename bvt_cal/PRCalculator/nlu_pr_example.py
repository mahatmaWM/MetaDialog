...
def app_key_domain():
    ...
    data_frame = pd.read_excel('select_data100.xlsx')
    # data_frame.head(6)
    ...
    agg_columns = ['domain_intent']  # 聚合列名, app_Key统计的指标
...
def app_key_domain_intent():
    ...
    agg_columns = ['domain_intent', 'domain_name']    # 聚合列名, app_Key统计的指标(脱敏于true_**, pred_**)
